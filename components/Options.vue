      ...
      <template #panel>
        <div class="flex flex-col">
          ...
          <span @click="confirm = true" v-if="partida.status != 'finalizada' && !confirm && simulacao.get(partida.id)"
            ...
            <Icon size="1rem" name="mynaui:trash" />
